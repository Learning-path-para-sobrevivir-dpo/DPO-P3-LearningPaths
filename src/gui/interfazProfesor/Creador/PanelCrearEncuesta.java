...
public class PanelCrearEncuesta extends JPanel implements ActionListener {
	...
	public PanelCrearEncuesta(VentanaCrearActividad ventanaAct) {
		super();
        ...
        bCrear = new JButton("Crear Encuesta");
